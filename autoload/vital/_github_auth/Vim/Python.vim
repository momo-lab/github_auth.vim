...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_github_auth#Vim#Python#import() abort
  ...
  execute join(['function! vital#_github_auth#Vim#Python#import() abort', printf("return map({'eval_expr': '', 'is_python2_enabled': '', 'is_python3_enabled': '', 'exec_file': '', 'set_major_version': '', 'is_enabled': '', 'get_major_version': '', 'exec_code': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
