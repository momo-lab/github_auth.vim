...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_github_auth#Web#API#GitHub#import() abort
    return map({'set_config': '', '_vital_depends': '', 'parse_response_link': '', 'parse_response_rate_limit': '', '_vital_created': '', 'get_config': '', 'parse_response': '', 'build_exception_message': '', 'parse_response_last_modified': '', 'parse_response_etag': '', 'new': '', '_vital_loaded': ''},  'function("s:" . v:key)')
  endfunction
else
  function! s:_SID() abort
    return matchstr(expand('<sfile>'), '<SNR>\zs\d\+\ze__SID$')
  endfunction
  execute join(['function! vital#_github_auth#Web#API#GitHub#import() abort', printf("return map({'set_config': '', '_vital_depends': '', 'parse_response_link': '', 'parse_response_rate_limit': '', '_vital_created': '', 'get_config': '', 'parse_response': '', 'build_exception_message': '', 'parse_response_last_modified': '', 'parse_response_etag': '', 'new': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
